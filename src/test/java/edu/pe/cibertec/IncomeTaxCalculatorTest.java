...
public class IncomeTaxCalculatorTest {
    ...
    private static double UIT = 4_950.0;
    ...
    void givenIncomeBelowSevenUIT_whenCalculate_thenZeroTax() {
        double income = 6 * UIT;
    ...
    void givenIncomeExactlySevenUIT_whenCalculate_thenZeroTax() {
        double income = 7 * UIT;
        assertEquals(0.0, calculator.calculate(income), DELTA);
    }
    ...
    void givenIncomeInBracketSevenToTwelveUIT_whenCalculate_thenRightPercent() {
